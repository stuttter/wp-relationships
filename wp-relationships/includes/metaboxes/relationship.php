...
?>
	...
	<table class="form-table">
		<tr class="relationship-from-wrap">
			...
			<td><input type="number" name="relationship_from" id="relationship_from" value="<?php echo esc_attr( $relationship->relationship_from ); ?>" class="code" /></td>
		</tr>
		<tr class="relationship-top-wrap">
			<th><label for="relationship_top"><?php esc_html_e( 'To', 'wp-relationships' ); ?></label></th>
			<td><input type="number" name="relationship_top" id="relationship_to" value="<?php echo esc_attr( $relationship->relationship_to ); ?>" class="code" /></td>
		</tr>
	</table>
